            ...
            <Box>
                <FormControl fullWidth sx={{ mb: 3 }}>
                    <TextField
                        ...
                        value={formik.values.name || hit?.name || ''}
                ...
                <FormControl fullWidth sx={{ mb: 3 }}>
                    <TextField
                        ...
                        value={formik.values.description || hit?.description || ''}
                        onChange={formik.handleChange}
                ...
                <FormControl fullWidth sx={{ mb: 3 }}>
                    <TextField
                        ...
                        type="create"
                        value={formik.values.create || hit?.createUser?.name || ''}
                        onChange={formik.handleChange}
                ...
                <FormControl fullWidth sx={{ mb: 3 }}>
                    <TextField
                        ...
                        type="assign"
                        value={formik.values.assign || hit?.assignUser?.name || ''}
                        onChange={formik.handleChange}
